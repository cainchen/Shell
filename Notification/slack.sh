...
## Commemented by Cain Chen - Augest 9,2018
# I'm not the creator.'
# Taken from: https://gist.github.com/andkirby/67a774513215d7ba06384186dd441d9e
# This script is passed(tested) for:
#   - macOS 10.13.5
#   - Ubuntu 14 go 17  
# How to use this script:
#  <path>/slack.sh <#channel 1> <#channel 2> <your message>

## Added by Cain Chen - Augest 9 - 2018
export APP_SLACK_WEBHOOK=<Add your slack webhook address in here>
export APP_SLACK_CHANNEL=<Add which channel of slack want to reciving message>
